      ...
      <div className="bg-surface-secondary rounded-2xl border border-border w-full max-w-lg shadow-2xl max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-border">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-content rounded-xl flex items-center justify-center">
              <FolderPlus className="w-5 h-5 text-content-inverse" />
            </div>
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-surface-tertiary border border-border rounded-xl text-content placeholder-content-muted focus:outline-none focus:ring-2 focus:ring-border-strong focus:border-transparent transition-colors"
              maxLength={50}
              required
              autoFocus
            />
          ...
          <div>
            <label className="block text-sm font-semibold text-content mb-2">
              Project Image <span className="text-content-muted font-normal">(Optional)</span>
            </label>
            
            {!imagePreview ? (
              <label className="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-border rounded-xl cursor-pointer hover:border-border-strong hover:bg-surface-hover transition-colors">
                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                  <Upload className="w-10 h-10 text-content-muted mb-3" />
          ...
          <div>
            ...
            <div className="flex items-center gap-3 px-4 py-3 bg-surface-tertiary rounded-xl border border-border">
              {imagePreview ? (
                <img
                  src={imagePreview}
                  alt="Preview"
        ...
        <div className="flex gap-3 px-6 py-5 border-t border-border">
          ...
          <button
            ...
            className="flex-1 px-4 py-3 bg-content text-content-inverse font-semibold rounded-lg shadow-[0_2px_0_0_var(--border-strong)] hover:shadow-[0_1px_0_0_var(--border-strong)] hover:translate-y-[1px] active:shadow-none active:translate-y-[2px] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
