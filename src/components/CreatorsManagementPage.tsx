...
import { User, TrendingUp, Plus, Mail, Clock, X, FileText, UserPlus, Copy, Trash2, MoreVertical, Edit3, DollarSign } from 'lucide-react';
                    ...
                    >
                      ...
                      >
                        <div className="flex items-center gap-2">
                          ...
                          {(profile?.customPaymentTerms || profile?.paymentPlan) && (
                            <TrendingUp className="w-3 h-3 text-green-400" />
                          )}
                        </div>
                        {profile?.paymentPlan ? (
                          <div className="text-xs text-gray-500 mt-0.5 capitalize">
                            {profile.paymentPlan.type === 'flat_plus_cpm' ? 'Flat + CPM' : profile.paymentPlan.type}
                          </div>
                        ) : profile?.customPaymentTerms ? (
