 ...
 * Redirects to the new billing page
 */
const BillingTabContent: React.FC = () => {
  useEffect(() => {
    // Automatically redirect to the new billing page
  ...
  return (
    <div className="space-y-6">
      <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-white/10 p-12 text-center">
        ...
        <p className="text-gray-600 dark:text-gray-400">Redirecting to billing page...</p>
      </div>
    </div>
  );
};
