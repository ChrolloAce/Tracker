    ...
    <div className="min-h-screen bg-surface text-content">
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-content-muted">Manage your organization's subscription and billing information.</p>
        </div>
          ...
          <div className="bg-surface-secondary border border-border rounded-xl p-6">
            ...
            <div className="flex items-center justify-end gap-3 mt-6 pt-6 border-t border-border">
              <button
                ...
                className="flex items-center gap-2 px-6 py-2.5 bg-orange-500 text-white rounded-xl font-semibold shadow-[0_4px_0_0_#c2410c] hover:shadow-[0_2px_0_0_#c2410c] hover:translate-y-[2px] active:shadow-none active:translate-y-[4px] transition-all"
              >
                <TrendingUp className="w-4 h-4" />
                Upgrade Plan
              </button>
              <button className="p-2.5 hover:bg-surface-hover rounded-lg transition-colors">
                <MoreHorizontal className="w-5 h-5 text-content-muted" />
              </button>
            </div>
          </div>
        </div>
...
const UsageCard: React.FC<UsageCardProps> = ({ label, status, available }) => {
  if (!available) {
    return (
      <div className="bg-surface-secondary border border-border rounded-2xl p-6 flex flex-col items-center justify-center">
  ...
  return (
    <div className="bg-surface-secondary border border-border rounded-2xl p-6 flex flex-col items-center justify-center hover:bg-surface-hover transition-colors">
      <div className="relative w-24 h-24 mb-4">
        {/* Background circle */}
        <svg className="w-full h-full transform -rotate-90">
          <circle
