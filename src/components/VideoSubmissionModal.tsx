        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            <label className="block text-sm font-medium text-gray-700">
              Instagram, TikTok, or YouTube Video URLs
            </label>
            <Button
              type="button"
              variant="secondary"
                ...
                <div className="flex items-start space-x-2">
                  <div className="flex-1">
                    ...
                    <input
                      ...
                      placeholder="https://www.instagram.com/p/... or https://www.tiktok.com/@user/video/... or https://www.youtube.com/shorts/ID or https://youtu.be/ID or https://www.youtube.com/watch?v=ID"
