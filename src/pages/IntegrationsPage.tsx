...
const IntegrationsPage: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'credentials' | 'apps'>('credentials');
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] p-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-white/60">Connect and manage third-party services</p>
      </div>
      ...
      <div className="bg-white/5 rounded-xl border border-white/10 overflow-hidden">
        ...
        <div className="flex flex-col items-center justify-center py-16 px-6">
          ...
          <p className="text-white/60 text-center max-w-md mb-6">
            Start syncing data from various providers.
          </p>

          {/* Setup Instructions */}
          <div className="text-center max-w-2xl space-y-2">
            <p className="text-sm text-white/50">
              Connect your Apple Developer Account by adding credentials with the button above.
            </p>
            <p className="text-sm text-white/50">
              After the setup is complete, you must associate your app with a project.
            </p>
          </div>
        </div>
